...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SLOT_0_AXI_araddr [ create_bd_port -dir I -from 8 -to 0 SLOT_0_AXI_araddr ]
  ...
  set SLOT_0_AXI_awaddr [ create_bd_port -dir I -from 8 -to 0 SLOT_0_AXI_awaddr ]
  ...
  set SLOT_0_AXI_wstrb [ create_bd_port -dir I -from 3 -to 0 SLOT_0_AXI_wstrb ]
